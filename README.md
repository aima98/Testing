...
**[Testing]** is a project about Testing, that takes part in Microverse program. The patern AAA is used to test JavaScript code.
...
- **cd your-folder**
- **git clone https://github.com/aima98/Testing**
